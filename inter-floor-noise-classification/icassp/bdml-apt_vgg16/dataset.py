...
if __name__ == "__main__":
    ...
    # Names
    pp_n = {'output_tr':'train_type_3s_224_224',            # 'type' <-> 'position' (or 'floor')
            'output_v':'valid_type_3s_224_224',             # 'type' <-> 'position' (or 'floor')
            'output_t':'test_type_3s_224_224',              # 'type' <-> 'position' (or 'floor')
            'fold_conf':'conf_1',                           # 'fold_conf_x' (select one in the metadata)
