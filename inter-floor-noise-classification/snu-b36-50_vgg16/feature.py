...
Descriptions
    ...
    # Since the input of AlexNet is 224 x 224 x 3, the code stacks 3 patches
"""
...
def feature(tid, event_start=0):
    try:
        ...
        n_mels = 224; n_width = n_mels; offset = 0.05
        # Time duration; window_length; FFT_point; hop_length
        time_len = 3; win_length = 591; n_fft = 2048; hop_length = 591
        # File path
...
if __name__ == "__main__":
    ...
    result, feature = feature(15000, 0); print(feature.shape)
