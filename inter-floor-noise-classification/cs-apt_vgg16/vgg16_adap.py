"""
Description
    VGG16_adap for supervised learning of inter-floor noise
...
class vgg16:
    ...
    def __init__(self, imgs, img_mean, weights=None, sess=None, bn=False, bn_is_training=True, num_output=None):
        ...
        self.convlayers()
        self.fc_layers()
        #self.probs = tf.nn.softmax(self.fc3l)      # Disabled
    ...
    def convlayers(self):
        ...
        with tf.name_scope('preprocess') as scope:
            #mean = tf.constant([123.68, 116.779, 103.939], dtype=tf.float32, shape=[1, 1, 1, 3], name='img_mean')          # Disabled
...
if __name__ == '__main__':
    ...
    # generate an instance; the instance will be initialized by "__init__( )"
